...
export declare function createComparisonOperation({ operator, propertyRefOrCoalesce, param, durationField, pointField, }: {
...
export declare function createBaseOperation({ operator, target, value, }: {
    operator: string;
    target: Cypher.Expr;
    value: Cypher.Expr;
}): Cypher.ComparisonOp;
