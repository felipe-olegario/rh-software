 ...
 **/
export declare function getConcreteEntitiesInOnArgumentOfWhere(compositeTarget: UnionEntityAdapter | InterfaceEntityAdapter, whereArgs?: Record<string, any>): ConcreteEntityAdapter[];
