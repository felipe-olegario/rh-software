...
export declare class FilterFactory {
    ...
    createConnectionPredicates(rel: RelationshipAdapter, entity: ConcreteEntityAdapter | InterfaceEntityAdapter | UnionEntityAdapter, where: GraphQLWhereArg | GraphQLWhereArg[]): Filter[];
    ...
    createNodeFilters(entity: ConcreteEntityAdapter | InterfaceEntityAdapter | UnionEntityAdapter, where: Record<string, unknown>): Filter[];
