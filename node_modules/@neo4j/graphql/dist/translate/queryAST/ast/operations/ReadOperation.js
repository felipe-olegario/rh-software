...
class ReadOperation extends operations_1.Operation {
    ...
    transpileNestedRelationship(entity, { context, returnVariable }) {
        ...
        const authFilterSubqueries = this.getAuthFilterSubqueries(nestedContext).map((sq) => new cypher_builder_1.default.Call(sq).innerWith(targetNode));
        ...
        const clause = cypher_builder_1.default.concat(...preSelection, ...authFilterSubqueries, matchClause, withWhere, subqueries, ...sortSubqueries, ret);
        return {
            clauses: [clause],
    ...
    transpile({ context, returnVariable }) {
        ...
        const authFilterSubqueries = this.getAuthFilterSubqueries(context).map((sq) => new cypher_builder_1.default.Call(sq).innerWith(node));
