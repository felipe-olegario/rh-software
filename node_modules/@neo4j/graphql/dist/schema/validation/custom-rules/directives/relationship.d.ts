import type { DirectiveNode, FieldDefinitionNode, EnumTypeDefinitionNode, InterfaceTypeDefinitionNode, UnionTypeDefinitionNode, InterfaceTypeExtensionNode } from "graphql";
...
export declare function verifyRelationshipFieldType({ traversedDef, }: {
    traversedDef: ObjectOrInterfaceWithExtensions | FieldDefinitionNode;
}): void;
