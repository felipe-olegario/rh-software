...
export declare function relationshipAdapterToComposeFields(objectFields: RelationshipAdapter[], userDefinedFieldDirectives: Map<string, DirectiveNode[]>): Record<string, ObjectTypeComposerFieldConfigAsObjectDefinition<any, any>>;
...
export declare function attributesToSubscriptionsWhereInputFields(entityWithAttributes: ConcreteEntityAdapter | InterfaceEntityAdapter | RelationshipAdapter): Record<string, InputField>;
